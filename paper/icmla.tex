...
\title{\indicns: Improved Non-Intrusive load monitoring using Division and Calibration}
...
\begin{figure} 
    ...
    \hspace{2pt}
    \subfloat[\scriptsize Confusion matrix for refrigerator after applying \indicns-CO based NIALM. There are more instances along the diogonal sginfifying improvement in prediction. State 2 shows significant improvements.]{
