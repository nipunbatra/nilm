...
\title{\indicns: Improved Non-Intrusive load monitoring using load Division and Calibration \vspace{-10mm}}
...
\begin{figure} 
    ...
    \includegraphics[scale=0.34]{./figures/ref_confusion_before.png}}
    \hspace{2pt}
    \subfloat[\scriptsize After applying \indicns-CO based NIALM - Significant improvement in State 2 and 3 prediction]{
        \includegraphics[scale=0.34]{./figures/ref_confusion_after.png}}
        \vspace{-8pt}
