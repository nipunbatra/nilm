...
\item Release of open source implementation of the proposed work\footnote{\url{http://www.iiitd.edu.in/~amarjeet/Research/indic.zip}} for comparative analysis with other NILM approaches as an IPython notebook\footnote{\url{http://www.ipython.org}}. 
\end{itemize}
