...
\noindent We use Reference Energy Disaggregation Data Set (REDD)~\cite{redd} for validating the improvements in disaggregation using \indic based CO. %using the metrics as discussed in \secref{sec:metrics}. %based on metrics such as Mean normalized error (MNE) and RMS error (RE) proposed in previous work.
